          ...
          <div className="sidebar-dextop">
            <ul>
              ...
              <li onClick={togglesubmenu}>
                <div>
                  <i className="fa fa-gavel" aria-hidden="true"></i> {props.name2}
                </div>
                <ul id="sidesubbar">
                  <li>
              ...
              <li onClick={togglesubmenua}>
                <div>
                  <i className="fa fa-book" aria-hidden="true"></i> {props.name3}
                </div>
                <ul id="sidesubbar1">
                  <li>
              ...
              <li onClick={togglesubmenub}>
                <div>
                <i className="fa fa-heart" aria-hidden="true"></i> {props.name4}
                </div>
                <ul id="sidesubbar2">
                  <li>
              ...
              <li onClick={togglesubmenuc}>
                <div>
                <i className="fa fa-h-square" aria-hidden="true"></i> {props.name9}
                </div>
                <ul id="sidesubbar3">
                  <li>
              ...
              <li onClick={togglesubmenud}>
                <div>
                <i className="fa fa-newspaper-o" aria-hidden="true"></i>{props.name5}
                </div>
                <ul id="sidesubbar4">
                  <li>
              ...
              <li onClick={togglesubmenue}>
                <div>
                  <i className="fa fa-book" aria-hidden="true"></i> {props.name6}
                </div>
                <ul id="sidesubbar5">
                  <li>
              ...
              <li onClick={togglesubmenuf}>
                <div>
                  <i className="fa fa-book" aria-hidden="true"></i> {props.name7}
                </div>
                <ul id="sidesubbar6">
                  <li>
              ...
              <li onClick={togglesubmenug}>
                <div>
                  <i className="fa fa-book" aria-hidden="true"></i> {props.name8}
                </div>
                <ul id="sidesubbar7">
                  <li>
